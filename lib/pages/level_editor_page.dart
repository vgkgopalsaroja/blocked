...
class LevelEditorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: BlocConsumer<LevelEditorBloc, LevelEditorState>(
              ...
              return Scaffold(
                body: Stack(
                  children: [
                    ...
                    SelectableText(generatedLevel.initialState.toMapString()),
                  ],
                ),
              );
            }));
                ...
                children: [
                  Positioned.fill(
                    child: GestureDetector(
                        ...
                        onTap: () {
                          levelEditorBloc.add(const EditorObjectSelected(null));
                        }),
                  ),
